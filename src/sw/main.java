...
public class main extends JFrame { 
    ...
    public main(String title) { 
        super(title); 
        initFrame(); /* w  w w   .   d  e m   o2   s   .c    o  m*/
    } 
    ...
    private JPanel getButtonPanel() { 
        ...
        underlineBtn.addActionListener(e -> 
                                  setNewStyle("underline", true)); 
        superscriptBtn.addActionListener(e -> 
                                setNewStyle("superscript", true)); 
    ...
    private void addStyles() { 
        ...
        StyleConstants.setAlignment(rightStyle, 
